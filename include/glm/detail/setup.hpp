...
#if GLM_COMPILER & GLM_COMPILER_CLANG
//TODO: Make a better hack. Support for C++11 and GLM simultaneously on android is broke in latest toolchain
#	if defined(_LIBCPP_VERSION) && GLM_LANG & GLM_LANG_CXX11_FLAG && !defined(ANDROID)
